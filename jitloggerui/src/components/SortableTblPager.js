		...
		render() {			
			...
			return (
				<div className="form-group">
					<div className="pager col-sm-4">
						<input type="button" className="pager-btn btn btn-warning" name="" disabled={prevDisableStyle} 
						...
						<input type="button" className="pager-btn btn btn-warning" name="" disabled={nextDisableStyle} 
					...
					<div className="desc col-sm-4">
						<div>Page {this.state.currPage + 1} out of {this.props.totalPage}, Total {this.props.totalsCount} records</div>
					</div>
				</div>
			);
		}
